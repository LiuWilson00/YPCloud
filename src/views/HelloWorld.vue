<template >
      <v-layout justify-cente align-center column>
          ...
          <v-data-table class="hello__paramList my-3 elevation-1" :headers="headers" :items="tableParams" hide-default-footer><template v-slot:items="props"><td class="text-xs-center"></td><td class="text-xs-center"></td></template></v-data-table>
      </v-layout>
</template>
